...
import mfw.gui.slot.slotCanInsertOnlyItemFerrisBasket;
...
public class ContainerFerrisBasketConstructor extends Container
{
    private TileEntityFerrisBasketConstructor tileFerrisCore;
//    private int lastConstructTime;
    private String ItemName;
    
    public ContainerFerrisBasketConstructor(InventoryPlayer invPlayer, TileEntityFerrisBasketConstructor tile)
    {
        this.tileFerrisCore = tile;
        this.addSlotToContainer(new slotCanInsertOnlyItemFerrisBasket(tile, 0, 257, 57));
...
//        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if(!(itemstack1.getItem() instanceof itemFerrisBasket))return null;
